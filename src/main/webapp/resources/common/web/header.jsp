	...
	<div class="container-menu-header">
		...
		<div class="wrap_header">
			...
			<a href="index.html" class="logo"> <img
				src='<c:url  value="/resources/templates/web/images/icons/logo.png" />'
				alt="IMG-LOGO">
			</a>
					...
					<div class="header-cart header-dropdown">
						<ul class="header-cart-wrapitem">
							...
							<li class="header-cart-item">
								<div class="header-cart-item-img">
									<img
										src='<c:url  value="/resources/templates/web/images/item-cart-02.jpg" />'
										alt="IMG">
								</div>
							...
							<li class="header-cart-item">
								<div class="header-cart-item-img">
									<img
										src='<c:url  value="/resources/templates/web/images/item-cart-03.jpg" />'
										alt="IMG">
								</div>
