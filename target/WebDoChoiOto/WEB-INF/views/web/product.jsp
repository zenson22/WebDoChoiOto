					...
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<ul class="p-b-54">
							<c:forEach items="${categories }" var="category">
								<li class="p-t-4"><a href='<c:url value="/san-pham/danh-muc/${category.id }" />' class="s-text13"> ${category.name }</a></li>
							</c:forEach>
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
									...
									<c:forEach var="img" items="${product.imageses}">
								...
								<div class="block2-txt p-t-20">
									<a href='<c:url value="/san-pham/chi-tiet-san-pham/${product.productId}" />' class="block2-name dis-block s-text3 p-b-5">
										${product.name}
									</a>
